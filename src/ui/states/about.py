...
class about(object):
    def __init__(self, screen, font):
        ...
        # 多行文字
        line1 = font.render("made by Simple", True, (200, 200, 200))
        line2 = font.render("数据结构课程作业", True, (200, 200, 200))
        self.lines = [line1, line2]
        self.line_rects = []
        for i, line in enumerate(self.lines):
            rect = line.get_rect(center=(self.width // 2, self.height // 2 - 30 + i * 50))
        ...
        self.back_rect.center = (self.width // 2, self.height // 2 + 100)
    ...
    def draw(self):
        ...
        for line, rect in zip(self.lines, self.line_rects):
            self.screen_surface.blit(line, rect)
